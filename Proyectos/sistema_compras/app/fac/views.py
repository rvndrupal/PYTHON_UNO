...
class ClienteNew(VistaBaseCreate): #Hereda del de arriba y de Vista create
    model=Cliente
...
def clienteInactivar(request,id):
    ...
    if request.method=="POST":
        if cliente:
            cliente.estado = not cliente.estado  #con esto se vulve lo contrario de true a false 
            cliente.save()
