...
class Test_013(unittest.TestCase):
    ...
    def test_013(self):
        ...
        localizador = self.driver.find_element(By.XPATH,"/html[1]/body[1]/header[1]/div[1]/div[2]/ul[1]/li[2]/a[1]")

        action = ActionChains(self.driver)

        action.move_to_element(localizador) #Muevete al elemento
        action.perform()
        ...
        #siempre dejar tiempos para que habra
